...
public class MobileContact {
    ...
    public boolean insertContact(String firstname, String lastname, String phoneNumber) {
        if(isFull(contacts)) {
            return false;
        }
    ...
    public boolean updateContact(String firstname, String lastname, String phoneNumber) {
        ...
        contacts[positiontoUpdate].setPhoneNumber(phoneNumber);
        return true;
    }
    ...
    private boolean isFull(MobileContact[] contacts) {
