...
public class CalculatorApp2 {
     ...
     * If the input leads to divide by zero error
     * (in div or mod) then the result is Integer.MIN_VALUE.
     *
     * @param choice    choice should be 1 for Add, 2 for Sub,
     *                  3 for Mul, 4 for Div, 5 for Mod. Any other choice
     *                  leads to an error state and the method returns
     *                  Integer.MAX_VALUE.
     *
     * @param num1      the first input number.
     * @param num2      the second input number.
     * @return          the result of the operation based on choice and the two input numbers.
     */
